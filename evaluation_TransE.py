...
def evaluation_helper(testList, tripleDict, dict, model, ent_embeddings, rel_embeddings, L1_flag, filter, head=0):
...
def process_data(testList, tripleDict, dict, model, ent_embeddings, rel_embeddings, L1_flag, filter, L, head):
    rankListHead, rankListTail = evaluation_helper(testList, tripleDict, dict, model, ent_embeddings, rel_embeddings, L1_flag, filter, head)

    L.append((rankListHead, rankListTail))


# Use multiprocessing to speed up evaluation
def evaluation(testList, tripleDict, dict, model, ent_embeddings, rel_embeddings, L1_flag, filter, k=0, head=0):
    ...
    L = []
    process_data(testList, tripleDict, dict, model, ent_embeddings, rel_embeddings, L1_flag, filter, L, head)
...
def evaluation_batch(testList, tripleDict, dict, model, ent_embeddings, rel_embeddings, L1_flag, filter, k=0, head=0):
    # embeddings are numpy like
