...
if __name__ == "__main__":
    ...
    trainTotal, trainList, trainDict = load_quadruples_TTransE('./data/' + args.dataset, 'train2id.txt')
    validTotal, validList, validDict = load_quadruples_TTransE('./data/' + args.dataset, 'valid2id.txt')
    quadrupleTotal, quadrupleList, quadrupleDict = load_quadruples_TTransE('./data/' + args.dataset, 'train2id.txt', 'valid2id.txt', 'test2id.txt')
    config = Config()
    ...
    config.entity_total, config.relation_total, config.tem_total = get_total_number('./data/' + args.dataset, 'stat.txt')
